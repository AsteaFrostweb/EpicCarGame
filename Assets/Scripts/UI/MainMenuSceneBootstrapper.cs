...
public class MainMenuSceneBootstrapper : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        MainMenuUIController controller = new GameObject("MainMenuUIController").AddComponent<MainMenuUIController>();
        ...
        controller.Configure(playSceneName, mainMenuPanel, settingsPanel, masterVolume, musicVolume, sfxVolume, mouseSensitivity, fullscreen, invertY, quality);
        ...
        backButton.onClick.AddListener(controller.ShowMainMenu);
        resetButton.onClick.AddListener(controller.ResetSettings);
        masterVolume.onValueChanged.AddListener(controller.SetMasterVolume);
        musicVolume.onValueChanged.AddListener(controller.SetMusicVolume);
        sfxVolume.onValueChanged.AddListener(controller.SetSfxVolume);
        mouseSensitivity.onValueChanged.AddListener(controller.SetMouseSensitivity);
        fullscreen.onValueChanged.AddListener(controller.SetFullscreen);
        invertY.onValueChanged.AddListener(controller.SetInvertY);
        quality.onValueChanged.AddListener(controller.SetQualityLevel);
    }
    ...
    private void CreateTitle(Transform parent, string text, Vector2 position, int fontSize)
    {
    ...
    private Slider CreateSettingSlider(Transform parent, string label, Vector2 position, float min, float max, float value)
    {
    ...
    private Toggle CreateSettingToggle(Transform parent, string label, Vector2 position, bool value)
    {
    ...
    private Dropdown CreateSettingDropdown(Transform parent, string label, Vector2 position)
    {
        CreateSettingLabel(parent, label, position + new Vector2(-230f, 0f));
    ...
    private void CreateSettingLabel(Transform parent, string label, Vector2 position)
    {
    ...
    private Text CreateText(Transform parent, string name, string value, int fontSize, TextAnchor alignment, Color color)
    {
